            ...
            <tr style="background-color: <?= $rowColor ?>;">
                ...
                <td class="text-center">
                    <label class="switch view">
                        <input type="checkbox" name="view[]" value="<?= $menu['id_menu'] ?>"
                ...
                <td class="text-center">
                    <label class="switch edit">
                        <input type="checkbox" name="edit[]" value="<?= $menu['id_menu'] ?>"
                ...
                <td class="text-center">
                    <label class="switch delete">
                        <input type="checkbox" name="delete[]" value="<?= $menu['id_menu'] ?>"
            ...
            <div class="card-body">
                <form method="post" action="<?= site_url('role/updatePermission/' . $role_id) ?>">
                    ...
                    <div class="text-right mt-3">
                        <a href="<?= site_url('role/permission/' . $role_id) ?>" class="btn btn-secondary">
                            <i class="material-icons">arrow_back</i> Batal
                        </a>
                        <button type="submit" class="btn btn-primary">
                            <i class="material-icons">save</i> Simpan Akses
                        </button>
                    </div>
                </form>
            </div>
