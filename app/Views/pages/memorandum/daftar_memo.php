...
<script>
    ...
    $('#download-excel').on('click', function() {
        ...
        // Kirim request AJAX
        $.ajax({
            url: '<?= base_url('memorandum/exportToExcel') ?>', // Endpoint controller
            type: 'POST',
            data: filterData,
            xhrFields: {
            ...
            success: function(response) {
                ...
                var filename = (hasFilter ?
                    'Filter_Daftar_Memorandum_' :
                    'Daftar_Memorandum_') + timestamp + '.xlsx';
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
                    text: 'Data memorandum berhasil dihapus.',
