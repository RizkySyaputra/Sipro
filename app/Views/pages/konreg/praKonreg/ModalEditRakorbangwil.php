...
<form id="editMemoForm">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <ul class="list-group list-group-flush">
                    <label class="catatan-text"><strong>ID Program Tahunan Program Rakorbangwil</strong></label>
            ...
            <div class="col-md-6">
                <ul class="list-group list-group-flush">
                    ...
                    <p><?= nl2br(esc($progTahunan->catatan_pemda ?? '-')) ?></p>
                    ...
                    $val = $progTahunan->desk_rakorbangwil ?? '';
    ...
    <h6><i class="fas fa-comments me-2"></i><strong>Catatan Pra Konreg</strong></h6>

    <div id="deskWrapper">
        <?php
        $deskData = json_decode($prog_tahunan->catatan_pra_konreg ?? '[]', true);
    ...
    <select class="form-control form-control-lg fancy-kesepakatan"
        ...
        <?php foreach ($kesepakatan as $item): ?>
            ...
            <option value="<?= esc($item['id_kesepakatan']) ?>"
                <?= ($progTahunan->pra_konreg ?? '') == $item['id_kesepakatan'] ? 'selected' : '' ?>>
