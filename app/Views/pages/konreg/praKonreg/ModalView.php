...
<div class="container-fluid">
    ...
    <div class="card shadow-sm mb-4">
        <div class="card-header bg-primary text-white">
            <h5 class="mb-0"><i class="fas fa-file-alt me-2"></i> Detail Program Tahunan Rakorbangwil</h5>
        </div>
        <div class="card-body">
            <div class="row g-3">
                <div class="col-md-6">
                ...
                <div class="col-md-6">
                    <ul class="list-group list-group-flush">
                        ...
                        ?>
                        <label class="catatan-text"><strong>Kesepakatan Pra Konreg</strong></label>
                        <?php
                        $statusMap = [
                            "1" => "Diakomodasi",
                            "2" => "Ditangguhkan",
                            "3" => "Ditangguhkan (Geser Tahun)",
                            "4" => "Ditangguhkan (Skema KPBU)",
                            "5" => "Ditangguhkan (Sumber Pendanaan Lainnya)",
                            "6" => "Diakomodasi (Perubahan Menjadi Non PN",
                            "0" => "Belum dibahas"
                        ];

                        $val = $prog_tahunan->pra_konreg ?? '';
                ...
                <div class="col-md-12">
                    <ul class="list-group list-group-flush">
                        <li class="list-group-item">
                            <label class="catatan-text"><strong>Catatan Pra Konreg:</strong></label>
                            <?php if (!empty($prog_tahunan->catatan_pra_konreg)): ?>
                                <?php
                                $catatanList = json_decode($prog_tahunan->catatan_pra_konreg, true);
                                ?>
                                <?php if (!empty($catatanList)): ?>
                                    <div class="mt-2">
                                        <?php foreach ($catatanList as $item): ?>
