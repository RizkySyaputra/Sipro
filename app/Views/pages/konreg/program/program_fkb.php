    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title font-weight-bold"><strong>Program Konreg FKB</strong></h4>
                            ...
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-md-2 mb-3">
                                    ...
                                    <select class="form-control" name="kesepakatan" id="filter-Kesepakatan">
                                        ...
                                        <option value="x">Non FKS/Belum Terbahas</option>
...
<script>
    $(document).ready(function() {
        ...
        $('#filter-form').on('submit', function() {
            ...
            // Kirim request AJAX
            $.ajax({
                url: '<?= base_url(($desk) ? '/program/get_program_fkb?desk=konreg' : '/program/get_program_fkb') ?>', // URL untuk memproses filter
                type: 'POST',
                data: filterData,
                success: function(response) {
