    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title font-weight-bold"><strong>Rakorbangwil</strong></h4>
...
<script>
    $(document).ready(function() {
        $('#download-excel').on('click', function() {
            ...
            // Kirim request AJAX
            $.ajax({
                url: '<?= base_url('/konreg/exportToExcel') ?>', // Endpoint controller
                type: 'POST',
                data: filterData,
                xhrFields: {
                ...
                success: function(response) {
                    ...
                    link.download = 'Program_Rakorbangwil' + timestamp + '.xlsx'; // Nama file unduhan
                    link.click();
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
        ...
        $('#filter-unor, #filter-provinsi, #filter-sumber, #filter-pendanaan, #filter-pradesk').select2();
        ...
        $('#filter-form').on('submit', function() {
            ...
            // Kirim request AJAX
            $.ajax({
                url: '<?= base_url('/pradesk/get_program') ?>', // URL untuk memproses filter
                type: 'POST',
                data: filterData,
                success: function(response) {
