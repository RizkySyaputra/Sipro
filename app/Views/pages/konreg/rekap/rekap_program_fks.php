    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title font-weight-bold"><strong>Daftar List Program Desk Konreg FKS</strong></h4>
...
<script>
    $(document).ready(function() {
        ...
        $('#filter-form').on('submit', function() {
            ...
            // Kirim request AJAX
            $.ajax({
                url: '<?= base_url('/program/get_rekap_fks') ?>', // URL untuk memproses filter
                type: 'POST',
                data: filterData,
                success: function(response) {
