    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title font-weight-bold"><strong>Daftar List Program ditangguhkan</strong></h4>
...
<script>
    $(document).ready(function() {
        $('#download-excel').on('click', function() {
            ...
            // Kirim request AJAX
            $.ajax({
                url: '<?= base_url('/ditangguhkan/exportToExcel') ?>', // Endpoint controller
                type: 'POST',
                data: filterData,
                xhrFields: {
                ...
                success: function(response) {
                    ...
                    link.download = 'Program_ditangguhkan' + timestamp + '.xlsx'; // Nama file unduhan
                    link.click();
                    Swal.fire({
                        icon: 'success',
                        title: 'Success',
        ...
        $('#filter-form').on('submit', function() {
            ...
            // Kirim request AJAX
            $.ajax({
                url: '<?= base_url('/program/get_rekap_ditangguhkan') ?>', // URL untuk memproses filter
                type: 'POST',
                data: filterData,
                success: function(response) {
