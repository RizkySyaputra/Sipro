    ...
    <div class="col-md-12">
        <div class="card">
            <div class="card-header card-header-primary card-header-icon">
                ...
                <h4 class="card-title">Data Program Tahunan</h4>
            </div>
                ...
                <div class="card shadow-sm">
                    <div class="card-body">
                        <div class="material-datatables">
                            ...
                            <!-- Modal View/Edit -->
                            <div class="modal fade" id="memoModal" tabindex="-1" data-backdrop="static" data-keyboard="false" role="dialog" aria-labelledby="memoModalLabel" aria-hidden="true">
        ...
        $.ajax({
            ...
            success: function(response) {
                ...
                Swal.fire({
                    icon: 'success',
                    title: 'Berhasil!',
                    text: 'Data Program Tahunan berhasil dihapus.',
...
<script>
    $(document).ready(function() {
        ...
        $(document).on('click', '.btn-edit', function() {
            ...
            $.get("<?= base_url('rakorbangwil/edit') ?>/" + id, function(data) {
                $('#memoModal .modal-body').html(data);
            });
        });
