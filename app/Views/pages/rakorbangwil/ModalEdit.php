        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                <ul class="list-group list-group-flush">
                    ...
                    <label class="catatan-text"><strong>Tahun Pelaksana</strong></label>
                    <input type="number" class="form-control" name="thn_pelaksanaan" value="<?= esc($progTahunan->thn_pelaksanaan ?? '') ?>">
