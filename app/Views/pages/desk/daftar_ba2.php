                            ...
                            <div class="form-row align-items-center">
                                ...
                                <div class="col-md-3 mb-3">
                                    ...
                                    <select class="form-control" name="Unor" id="filter-Unor">
                                        <option value="11" selected>Semua Unor</option>
...
<script>
    $(document).ready(function() {
        ...
        $('#filter-Unor, #pejabatSelect').select2();
        // Restore values from local storage
        $('#filter-Unor').val(localStorage.getItem('selectedProvinsi'));
        ...
        $('#filter-form').on('submit', function() {
            ...
            $('#hiddenProvinsiIdForJabatan').val(unorId);
            ...
            //     type: 'POST',
            //     data: {
            //         provinsi_id: unorId // Kirimkan data provinsi_id jika diperlukan
            //     },
        ...
        $('#tanggal_ba').on('change', function() {
            ...
            var newUrl = '<?= base_url('addBak3/') ?>' + unorId + '/' + tanggal;
