...
$routes->get('rpiw/daftar_kawasan', 'Rpiw::daftar_kawasan', ['filter' => 'permission']);
...
$routes->get('rpiw/daftar_renaksi', 'Rpiw::daftar_renaksi', ['filter' => 'permission']);
...
$routes->get('rpiw/view/(:segment)', 'Rpiw::view/$1');
$routes->get('rpiw/edit/(:segment)', 'Rpiw::edit/$1');
$routes->post('rpiw/update/(:segment)', 'Rpiw::update/$1');
$routes->delete('/rpiw/delete/(:segment)', 'Rpiw::delete/$1');
...
$routes->post('/rakorbangwil/save_catatan_kawasan', 'Rakorbangwil::save_catatan_kawasan');
